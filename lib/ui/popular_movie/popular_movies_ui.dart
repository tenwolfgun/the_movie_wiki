...
class PopularMoviesUi extends StatefulWidget {
  @override
  _PopularMoviesUiState createState() => _PopularMoviesUiState();
}

class _PopularMoviesUiState extends State<PopularMoviesUi>
  ...
  void initState() {
    page = 1;
    _popularMovieBloc.onPopularMovieInitiated(page);
    super.initState();
  }
  ...
  Widget _nowPlayingMovies(PopularMovieState state) {
