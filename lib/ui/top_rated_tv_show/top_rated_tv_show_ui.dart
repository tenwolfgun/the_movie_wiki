...
class TopRatedTvShowUi extends StatefulWidget {
  @override
  _TopRatedTvShowUiState createState() => _TopRatedTvShowUiState();
}

class _TopRatedTvShowUiState extends State<TopRatedTvShowUi>
    with AutomaticKeepAliveClientMixin {
  final _topRatedTvShowBloc = kiwi.Container().resolve<TopRatedTvShowBloc>();
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return BlocProvider(
      create: (context) => _topRatedTvShowBloc,
  ...
  void initState() {
    page = 1;
    _topRatedTvShowBloc.onTopRatedTvShowInitiated(page);
    super.initState();
  }

  @override
  void dispose() {
    _topRatedTvShowBloc.close();
    super.dispose();
  }
  ...
  Scaffold _buildScaffold() {
    return Scaffold(
      ...
      body: BlocBuilder(
        bloc: _topRatedTvShowBloc,
        builder: (context, TopRatedTvShowState state) {
          if (state.isLoading) {
  ...
  Widget _nowPlayingMovies(TopRatedTvShowState state) {
  ...
  bool _handleScroolNotification(ScrollNotification notification) {
    if (notification is ScrollEndNotification &&
      ...
      page++;
      _topRatedTvShowBloc.onTopRatedTvNextResult(page);
    }
    return false;
  }
