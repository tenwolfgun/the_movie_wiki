...
import 'package:the_movie_wiki/ui/upcoming_movie/bloc.dart';
import 'package:smooth_star_rating/smooth_star_rating.dart';

class UpcomingMoviesUi extends StatefulWidget {
  @override
  _UpcomingMoviesUiState createState() => _UpcomingMoviesUiState();
}

class _UpcomingMoviesUiState extends State<UpcomingMoviesUi>
    with AutomaticKeepAliveClientMixin {
  final _upcomingMoviesBloc = kiwi.Container().resolve<UpcomingMovieBloc>();
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return BlocProvider(
      create: (context) => _upcomingMoviesBloc,
  ...
  @override
  void initState() {
    _upcomingMoviesBloc.add(UpcomingMovieInitiated());
    super.initState();
  }

  @override
  void dispose() {
    _upcomingMoviesBloc.close();
    super.dispose();
  }
  ...
  Scaffold _buildScaffold() {
    return Scaffold(
      ...
      body: BlocBuilder(
        ...
        builder: (context, UpcomingMovieState state) {
          if (state.isLoading) {
            return _buildLoader();
  ...
  Widget _nowPlayingMovies(UpcomingMovieState state) {
    return Scrollbar(
