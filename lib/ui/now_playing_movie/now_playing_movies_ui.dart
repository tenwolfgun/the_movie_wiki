...
class NowPlayingMoviesUi extends StatefulWidget {
  @override
  _NowPlayingMoviesUiState createState() => _NowPlayingMoviesUiState();
}

class _NowPlayingMoviesUiState extends State<NowPlayingMoviesUi>
    with AutomaticKeepAliveClientMixin {
  final _nowPlayingMoviesBloc = kiwi.Container().resolve<NowPlayingMovieBloc>();
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return BlocProvider(
      create: (context) => _nowPlayingMoviesBloc,
  ...
  void initState() {
    FirebaseAdMob.instance
        .initialize(appId: 'ca-app-pub-9768338049580158~7242274970');
    page = 1;
    _nowPlayingMoviesBloc.onNowPlayingMovieInitiated(page);
    super.initState();
  }

  @override
  void dispose() {
    _nowPlayingMoviesBloc.close();
    super.dispose();
  }
  ...
  Scaffold _buildScaffold() {
    return Scaffold(
      ...
      body: BlocBuilder(
        ...
        builder: (context, NowPlayingMovieState state) {
          if (state.isLoading) {
            return _buildLoader();
  ...
  Widget _nowPlayingMovies(NowPlayingMovieState state) {
  ...
  bool _handleScroolNotification(ScrollNotification notification) {
    if (notification is ScrollEndNotification &&
      ...
      page++;
      _nowPlayingMoviesBloc.onNowPlayingNextResult(page);
    }
    return false;
  }
